...
src_install() {
	...
	# The AppStream entry: without it KDE Discover lists the package as a bare
	# name. The file name IS the component id, so it goes in unrenamed.
	insinto /usr/share/metainfo
	doins dev.fileno.FileNo.metainfo.xml
